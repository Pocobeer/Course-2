...
xi = [10.3, 11.6, 12.9, 14.2, 15.5, 16.8, 18.1]
Px = [0.1, 0.15, 0.2, 0.15, 0.1, 0.2, 0.1]
ki = []
...
for i in range(1,m):
    random_value = RND()
    #for j in range(1,ki[i]):
        #A_l = xi[i] + random_value*(xi[i]-xi[i-1])
        #l = l+1
for i in range(1,l):
    rand_val = RND()
    p_1=rand_val(n-1)+1
