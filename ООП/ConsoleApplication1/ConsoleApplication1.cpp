...
int main() {
	...
	cout << "3 Пункт:" << endl;
	enum Human1;
	enum Human{Australian, Russian, French};
	Human human = Russian;
	if (human == Russian) {
	...
	cout << "4 Пункт:" << endl;
	cout << "Число байт, требуемое для хранения первого поля:" << sizeof(Structure.StructureNumber) << ", второго поля:" << sizeof(Structure.StructureFirstChar) << ", третьего поля:" << sizeof(Structure.StructureName) << endl;
	cout << "5 Пункт:" << endl;
	pi1 = (int)pi1;
	//cout << pi1 << endl;
